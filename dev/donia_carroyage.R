...
# Importing data ----
donia_talassa <- st_read(paths$processed$obs_donia)

# Carroyage data
hex_demi <- st_read(paste0(paths$raw$carroyage, "grille_talassa_2025_cotier_hexagone_demimile.shp"))
hex_quart <- st_read(paste0(paths$raw$carroyage, "grille_talassa_2025_cotier_hexagone_quartdemile.shp"))
hex_cinquieme <- st_read(paste0(paths$raw$carroyage, "grille_talassa_2025_cotier_hexagone_cinquiemedemile.shp"))
hex_dizieme <- st_read(paste0(paths$raw$carroyage, "grille_talassa_2025_cotier_hexagone_diziemedemile.shp"))
rect_demi <- st_read(paste0(paths$raw$carroyage, "grille_talassa_2025_cotier_rectangle_demimile.shp"))
rect_quart <- st_read(paste0(paths$raw$carroyage, "grille_talassa_2025_cotier_rectangle_quartdemile.shp"))
rect_cinquieme <- st_read(paste0(paths$raw$carroyage, "grille_talassa_2025_cotier_rectangle_cinquiemedemile.shp"))
rect_carpediem <- st_read(paste0(paths$raw$carroyage, "grille_carpediem_1m_2019_pnmcca_cotier.shp"))
...
hex_demi_lnduree <- aggregate_to_grid(
  ...
  id_field = "id_hex",
  output = paste0(paths$dev$donia_hex, "hex_demi_donia_lnduree.gpkg"),
...
hex_quart_lnduree <- aggregate_to_grid(
  ...
  transfo = "ln_mouillage",
  id_field = "id_hex",
  output = paste0(paths$dev$donia_hex, "hex_quart_donia_lnduree.gpkg"),
...
hex_cinquieme_lnduree <- aggregate_to_grid(
  ...
  transfo = "ln_mouillage",
  id_field = "id_hex",
  output = paste0(paths$dev$donia_hex, "hex_cinquieme_donia_lnduree.gpkg"),
...
hex_dizieme_lnduree <- aggregate_to_grid(
  ...
  id_field   = "id_hex",
  output     = paste0(paths$dev$donia_hex, "hex_dizieme_donia_lnduree.gpkg"),
...
hex_demi_lnall <- aggregate_to_grid(
  ...
  transfo = "ln_all",
  id_field = "id_hex",
  output = paste0(paths$dev$donia_hex, "hex_demi_donia_lnall.gpkg"),
...
hex_quart_lnall <- aggregate_to_grid(
  ...
  transfo = "ln_all",
  id_field = "id_hex",
  output = paste0(paths$dev$donia_hex, "hex_quart_donia_lnall.gpkg"),
...
hex_cinquieme_lnall <- aggregate_to_grid(
  ...
  transfo = "ln_all",
  id_field = "id_hex",
  output = paste0(paths$dev$donia_hex, "hex_cinquieme_donia_lnall.gpkg"),
...
hex_dizieme_lnall <- aggregate_to_grid(
  ...
  transfo = "ln_all",
  id_field = "id_hex",
  output = paste0(paths$dev$donia_hex, "hex_dizieme_donia_lnall.gpkg"),
...
rect_carpediem_lnall <- rect_carpediem %>%
  ...
  aggregate_to_grid(
    ...
    transfo = "ln_all",
    id_field = "id",
    output = paste0(paths$dev$donia_rect, "rect_carpediem_donia_lnall.gpkg"),
...
rect_demi_lnall <- aggregate_to_grid(
  ...
  transfo = "ln_all",
  id_field = "id",
  output = paste0(paths$dev$donia_rect, "rect_demi_donia_lnall.gpkg"),
...
rect_quart_lnall <- aggregate_to_grid(
  ...
  transfo = "ln_all",
  id_field = "id",
  output = paste0(paths$dev$donia_rect, "rect_quart_donia_lnall.gpkg"),
...
rect_cinquieme_lnall <- aggregate_to_grid(
  ...
  transfo = "ln_all",
  id_field = "id",
  output = paste0(paths$dev$donia_rect, "rect_cinquieme_donia_lnall.gpkg"),
