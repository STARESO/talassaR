#' ---
#' title : "talassaR - maillage scraps"
...
#' =============================================================================
#'
#' talassaR : Maillage scraps
#'
#' Description :
#' Morceaux de codes archives pour le maillage. Utilisé comme référence
#' d'inspiration pour la construction du script maillage_talassa_activites.R
#'
#' =============================================================================
